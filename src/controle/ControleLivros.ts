...
let livros: Array<Livro> = [
  ...
  },
  {
    ...
    resumo: "O Pequeno Príncipe narra a história de um menino que deixa seu pequeno planeta em busca de aventuras e encontra diversas criaturas pelo caminho, incluindo um piloto perdido no deserto do Saara. livro 2",
